/*
 *	File:	macros_stm32f10x.h
 *	Date:	31.08.2012
 *	Denis Zheleznyakov http://ziblog.ru
 */

#ifndef MACROS_STM32F10X_H_
#define MACROS_STM32F10X_H_

//------------------------------------------------------------------------------
#define MODE_OUTPUT_PUSH_PULL					MODE_OUTPUT_PUSH_PULL
#define MODE_OUTPUT_OPEN_DRAIN					MODE_OUTPUT_OPEN_DRAIN

#define MODE_AF_OUTPUT_PUSH_PULL				MODE_AF_OUTPUT_PUSH_PULL
#define MODE_AF_OUTPUT_OPEN_DRAIN				MODE_AF_OUTPUT_OPEN_DRAIN
